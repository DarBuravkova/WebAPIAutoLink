        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cars_FleetOwners_FleetOwnersId",
                        column: x => x.FleetOwnersId,
                        principalTable: "FleetOwners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cars_Locations_LocationsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsStatuss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarsStatuss_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_FleetOwnersId",
                table: "Cars",
                column: "FleetOwnersId");

            migrationBuilder.CreateIndex(
                name: "IX_Cars_LocationsId",
                table: "Cars",
                column: "LocationsId");

            migrationBuilder.CreateIndex(
                name: "IX_CarsStatuss_CarId",
                table: "CarsStatuss",
                column: "CarId",
                unique: true);
